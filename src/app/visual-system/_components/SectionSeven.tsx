...
const SEVEN_BASE = "https://pub-15da519210e34e4684d96a0ee4f478a3.r2.dev/section-7";
...
function Tile({
  ...
  const downloadHref = `/api/moodboard-download?dir=section-7&file=${fileName}`;
  ...
  return (
    ...
    >
      {play ? (
        <video
          ref={videoRef}
          src={`${SEVEN_BASE}/${n}.mp4`}
          poster={`${SEVEN_BASE}/${n}.png`}
          loop
          muted
          playsInline
          preload="none"
